...
public class QLOExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(QLODateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new QLOStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static QLODateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static QLODateTimeConverter dateTimeConverter = new QLOStandardDateTimeConverter();

    public QLOExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public QLOExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new QLOMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=QLOHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,QLOExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=QLOHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
