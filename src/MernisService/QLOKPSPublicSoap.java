...
public class QLOKPSPublicSoap
{
    ...
    public QLOKPSPublicSoap(){}

    public QLOKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public QLOKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        QLOExtendedSoapSerializationEnvelope envelope= new QLOExtendedSoapSerializationEnvelope(QLOExtendedSoapSerializationEnvelope.VER11);
